...
let LoginRegisterModuleComponent = class LoginRegisterModuleComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoginRegisterRoutingModule = class LoginRegisterRoutingModule {
};
...
let LoginComponent = class LoginComponent {
    ...
    OnSubmit() {
        ...
        if (this.loginForm.invalid == true) {
            ...
            this.http.post('/api/login', Object.assign(this.loginForm.value)).subscribe((data) => {
...
let RegisterUserComponent = class RegisterUserComponent {
    ...
    OnSubmit() {
        ...
        if (this.registerUserForm.invalid == true) {
            ...
            let postData = Object.assign(this.registerUserForm.value);
            this.http.post('/api/customer/register', postData).subscribe((data) => {
...
//# sourceMappingURL=login-register-module-login-register-module-es2015.js.map