...
var DashboardModuleComponent = /** @class */ (function () {
    function DashboardModuleComponent() {
    }
    DashboardModuleComponent.prototype.ngOnInit = function () {
    };
    ...
    return DashboardModuleComponent;
}());
...
var EditUserDetailsComponent = /** @class */ (function () {
    function EditUserDetailsComponent() {
    }
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('api/customer/getSessionDetails').subscribe(function (data) {
        }, function (error) {
...
//# sourceMappingURL=dashboard-module-dashboard-module-es5.js.map